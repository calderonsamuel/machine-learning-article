...
```{python}
'''
  No se pudo ocupar por el tiempo de ejecucion que tiene. Por esta razon se realizo un ajuste para aprobechar l
'''
...
selected_features = mi_df[mi_df['mutual_info'] > 0.01]['feature']  # umbral de información mutua
```
